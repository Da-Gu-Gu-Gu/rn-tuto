...
const appTheme = require('./theme');
console.log(appTheme.COLORS);
const banners = [
  {
    id: 1,
...
const categories = [
  {
    ...
    bg_color: appTheme.COLORS.primary20,
  },
  {
    id: 2,
    name: 'Bathtub',
    ...
    bg_color: appTheme.COLORS.error20,
  },
  {
    id: 2,
    name: 'Chair',
  ...
  },
  {
    ...
    bg_color: appTheme.COLORS.secondary20,
  },
];
